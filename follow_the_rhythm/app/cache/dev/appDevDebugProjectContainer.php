...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\InvitationFormType A AppBundle\Form\InvitationFormType instance.
     */
    protected function getApp_Form_InvitationService()
    {
        return $this->services['app.form.invitation'] = new \AppBundle\Form\InvitationFormType(new \AppBundle\Form\DataTransformer\InvitationToCodeTransformer($this->get('doctrine.orm.default_entity_manager')));
    }
    ...
    {
        $this->services['easyadmin.config.manager'] = $instance = new \EasyCorp\Bundle\EasyAdminBundle\Configuration\ConfigManager($this->get('easyadmin.cache.manager'), $this->get('property_accessor'), array('site_name' => 'Follow The Rhythm', 'entities' => array('Actualite' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Actualite', 'name' => 'Actualite'), 'Artiste' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Artiste', 'name' => 'Artiste'), 'Categorie' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Categorie', 'name' => 'Categorie'), 'Concert' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Concert', 'name' => 'Concert'), 'Message' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Message', 'name' => 'Message'), 'Moderateur' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Moderateur', 'name' => 'Moderateur'), 'Notification' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Notification', 'name' => 'Notification'), 'Signalement' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement', 'name' => 'Signalement'), 'Topic' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic', 'name' => 'Topic'), 'User' => array('class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\User', 'name' => 'User')), 'design' => array('assets' => array('css' => array(), 'js' => array(), 'favicon' => array('path' => 'favicon.ico', 'mime_type' => 'image/x-icon')), 'theme' => 'default', 'color_scheme' => 'dark', 'brand_color' => '#205081', 'form_theme' => array(0 => '@EasyAdmin/form/bootstrap_3_horizontal_layout.html.twig'), 'menu' => array()), 'formats' => array('date' => 'Y-m-d', 'time' => 'H:i:s', 'datetime' => 'F j, Y H:i'), 'disabled_actions' => array(), 'translation_domain' => 'messages', 'list' => array('actions' => array(), 'max_results' => 15), 'search' => array(), 'edit' => array('actions' => array()), 'new' => array('actions' => array()), 'show' => array('actions' => array(), 'max_results' => 10)), true);
        ...
        return array(
            ...
            'easyadmin.config' => array(
                ...
                'entities' => array(
                    ...
                    'Moderateur' => array(
                        'class' => 'follow_the_rhythm\\SymfonyBundle\\Entity\\Moderateur',
                        'name' => 'Moderateur',
                    ),
                    'Notification' => array(
