 ...
 */
class Topic extends \follow_the_rhythm\SymfonyBundle\Entity\Topic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'id', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'titre', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'date', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'nbSignalement', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'utilisateur', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Topic' . "\0" . 'categorie');
        }
