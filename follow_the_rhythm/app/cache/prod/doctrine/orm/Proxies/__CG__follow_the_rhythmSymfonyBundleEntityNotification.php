 ...
 */
class Notification extends \follow_the_rhythm\SymfonyBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Notification' . "\0" . 'texte', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Notification' . "\0" . 'date', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Notification' . "\0" . 'utilisateur');
        }
