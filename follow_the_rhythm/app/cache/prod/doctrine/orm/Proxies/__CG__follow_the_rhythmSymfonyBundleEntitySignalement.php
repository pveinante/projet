 ...
 */
class Signalement extends \follow_the_rhythm\SymfonyBundle\Entity\Signalement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement' . "\0" . 'id', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement' . "\0" . 'date', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement' . "\0" . 'commentaire', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement' . "\0" . 'message', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\Signalement' . "\0" . 'topic');
        }
