 ...
 */
class User extends \follow_the_rhythm\SymfonyBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'nbSignalement', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'artiste', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'concert', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'moderateur', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'UsersIAdd', '' . "\0" . 'follow_the_rhythm\\SymfonyBundle\\Entity\\User' . "\0" . 'myFriends', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
